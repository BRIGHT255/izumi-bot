...
DEBUG = process.env.DEBUG === undefined ? True : convertToBool(process.env.DEBUG);
...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID ||" izumi~kututenoye,"
  ...
  OWNER_NAME: process.env.OWNER_NAME || "chinozbright",
  BOT_NAME: process.env.BOT_NAME || "Iᴢᴜᴍɪ-ᴍᴅ",
  SUDO: process.env.SUDO || 0789598617 ,
  ...
  KOYEB_APP_NAME: process.env.KOYEB_APP_NAME || "bright",
